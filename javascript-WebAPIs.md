...
插件：就是别人写好的一些代码，我们只需要复制对应的代码，就可以直接实现效果。

学习插件的思路：

1. 看官网 了解插件可以完成什么需求
2. 查看基本使用流程
3. 写个demo 在线演示 找到符合自己的demo
4. 应用到实际开发中
...
是一种字符串匹配的模式。使用场景：手机号表单要求用户只能输入11位数字、也可以过滤掉一些敏感词
...
元字符：特殊含义的字符，可以极大提高灵活性和强大的匹配功能

- 边界符 定义位置的规则，必须用什么开头，什么结尾
...
- 范围 表示字符的范围 定义规则限定在某个范围，比如只能是英文字母或者数字等等，用[]表示范围
...
- 字符类 区分各种字符
- ![image-20260323211643390](C:\Users\cw139\AppData\Roaming\Typora\typora-user-images\image-20260323211643390.png)

### vscode正则插件

可以帮助我们快速生成正则表达式 any-rule